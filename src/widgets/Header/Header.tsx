            ...
            <nav className='flex items-end gap-x-12'>
                <ul className='flex items-end gap-x-4'>
                    <li className='border-black border-b-2 py-[14px] text-h5 px-4'>
                        <Link href={paths.products()} className='text-black font-bold'>Shop</Link>
                    </li>
                ...
                <ul className='flex items-end gap-x-2'>
                    <li className='border-transparent hover:border-black transition-all delay-150 ease-in-out border-b-2 w-14 h-14'>
                        <Link href={'#'} className='cursor-default w-full h-full flex justify-center items-center'>
                            <SearchSVG width={20} height={20} />
                        </Link>
                    </li>
                    <li className='border-transparent hover:border-black transition-all delay-150 ease-in-out border-b-2 w-14 h-14'>
                        <Link href={paths.wishlist} className='cursor-default w-full h-full flex justify-center items-center'>
                            <HeartSVG width={20} height={20} />
                        </Link>
                    </li>
                    <li className='border-transparent hover:border-black transition-all delay-150 ease-in-out border-b-2 w-14 h-14'>
                        <Link href={paths.shoppingCart} className='cursor-default w-full h-full flex justify-center items-center'>
